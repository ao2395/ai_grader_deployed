  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const questionResponse = await authenticatedFetch(`${process.env.NEXT_PUBLIC_BACKEND_URL || 'https://ai-grader-deployed-backend-155657669630.europe-west1.run.app'}/api/v1/questions/`);
